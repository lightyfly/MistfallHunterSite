...
export const siteCopy: Record<Locale, SiteCopy> = {
  ...
  ru: {
    ...
    home: {
      ...
      stats: ["🎮 Релиз 29 июля 2026", "🔄 Обновлено 15 августа 2026", "👥 14 941 игрок онлайн · снимок 13 августа", "⚔️ 6 игровых классов"],
      ctas: ["Начать гайд новичка", "Сравнить классы", "Проверить коды"], latest: "Последние официальные обновления", browseUpdates: "Все официальные обновления ↗", startHere: "Начать здесь", journey: "Ваш путь в Mistfall Hunter", popular: "Начните с фактов", trending: "Избранные материалы", about: "Что такое Mistfall Hunter?", explore: "Исследовать вики", exploreDescription: "Страницы на основе официальных источников: рейды, классы, снаряжение, сообщество и обновления.", faq: "Частые вопросы", faqDescription: "Ответы по официальным страницам и исследовательскому снимку от 15 августа 2026 года.", route: "Готовы освоить Mistfall Hunter?",
  ...
  de: {
    ...
    home: {
      ...
      stats: ["🎮 Start 29. Juli 2026", "🔄 Aktualisiert 15. August 2026", "👥 14.941 Spieler online · Snapshot 13. August", "⚔️ 6 spielbare Klassen"],
      ctas: ["Einsteiger-Guide starten", "Klassen vergleichen", "Aktive Codes prüfen"], latest: "Letzte offizielle Updates", browseUpdates: "Alle offiziellen Updates ↗", startHere: "Hier beginnen", journey: "Deine Mistfall-Hunter-Reise", popular: "Mit den Fakten starten", trending: "Ausgewählte Referenzen", about: "Was ist Mistfall Hunter?", explore: "Wiki erkunden", exploreDescription: "Referenzseiten aus offiziellen Quellen zu Extraction-Läufen, Klassen, Ausrüstung, Community und Updates.", faq: "Häufige Fragen", faqDescription: "Antworten auf Basis der offiziellen Seiten und des Recherche-Snapshots vom 15. August 2026.", route: "Bereit, Mistfall Hunter zu meistern?",
  ...
  zh: {
    ...
    home: {
      ...
      stats: ["🎮 2026 年 7 月 29 日上线", "🔄 2026 年 8 月 15 日更新", "👥 14,941 人在线 · 8 月 13 日快照", "⚔️ 6 个可玩职业"],
      ctas: ["开始新手指南", "对比职业", "查看兑换码状态"], latest: "最新官方更新", browseUpdates: "查看全部官方更新 ↗", startHere: "从这里开始", journey: "你的 Mistfall Hunter 旅程", popular: "先看已确认信息", trending: "精选参考", about: "Mistfall Hunter 是什么？", explore: "探索 Wiki", exploreDescription: "基于官方来源整理撤离、职业、装备、社区链接与版本更新资料。", faq: "常见问题", faqDescription: "依据官方页面与 2026 年 8 月 15 日调研快照整理。", route: "准备好掌握 Mistfall Hunter 了吗？",
...
export const homeUpdates: Record<Locale, Array<{ tone: "major" | "minor"; date: string; title: string }>> = {
  en: [{ tone: "major", date: "Aug 15, 2026", title: "Steam official notice — server configuration changes reduced stuttering; Soul Harvest launch rewards are sent by in-game mail, not a redemption code." }, { tone: "minor", date: "Aug 12, 2026", title: "Steam Fair Play notice — report suspected cheating or illegal teaming in-game; a report-result email feature is planned." }, { tone: "minor", date: "Aug 13, 2026", title: "Live-player snapshot — 14,941 players online at the time of research." }],
  ru: [{ tone: "major", date: "15 авг. 2026", title: "Официальное сообщение Steam — изменения конфигурации серверов снизили фризы; награды Soul Harvest отправляются внутриигровой почтой, а не кодом." }, { tone: "minor", date: "12 авг. 2026", title: "Сообщение Steam о честной игре — сообщайте о читах и незаконном тиминге; функция письма о результате жалобы планируется." }, { tone: "minor", date: "13 авг. 2026", title: "Снимок онлайна — на момент исследования в игре было 14 941 игрок." }],
  de: [{ tone: "major", date: "15. Aug. 2026", title: "Offizielle Steam-Mitteilung — Serveranpassungen verringerten Stottern; Soul-Harvest-Startbelohnungen kommen per In-Game-Post, nicht als Code." }, { tone: "minor", date: "12. Aug. 2026", title: "Steam-Mitteilung zu Fair Play — melde vermutete Cheats oder illegales Teaming im Spiel; eine E-Mail zum Ergebnis ist geplant." }, { tone: "minor", date: "13. Aug. 2026", title: "Spieler-Snapshot — zum Recherchezeitpunkt waren 14.941 Spieler online." }],
  "pt-br": [{ tone: "major", date: "15 ago. 2026", title: "Aviso oficial da Steam — ajustes nos servidores reduziram os travamentos; as recompensas de lançamento de Soul Harvest chegam por correio do jogo, não por código." }, { tone: "minor", date: "12 ago. 2026", title: "Aviso de Fair Play da Steam — denuncie suspeitas de trapaça ou teaming ilegal dentro do jogo; um e-mail sobre o resultado está planejado." }, { tone: "minor", date: "13 ago. 2026", title: "Snapshot de jogadores online — 14.941 jogadores no momento da pesquisa." }],
  zh: [{ tone: "major", date: "2026/08/15", title: "Steam 官方公告——服务器配置调整已减少卡顿；Soul Harvest 开服奖励通过游戏内邮件发放，不是兑换码。" }, { tone: "minor", date: "2026/08/12", title: "Steam 公平游玩公告——遇到疑似作弊或非法组队可在游戏内举报；举报结果邮件功能计划加入。" }, { tone: "minor", date: "2026/08/13", title: "在线人数快照——调研时记录为 14,941 人在线。" }],
};

export const journeySteps: Record<Locale, Array<{ number: string; title: string; description: string; href: string }>> = {
  en: [{ number: "1", title: "Beginner Guide", description: "Learn the controls, extraction loop, first loadout, and safe early routes before risking valuable gear.", href: "/beginner-guide" }, { number: "2", title: "How Extraction Works", description: "Understand solo and trio runs, map objectives, Returner Woodlings, and how to leave with your haul.", href: "/extraction" }, { number: "3", title: "Classes & Builds", description: "Compare all six classes, weapon stances, talents, active skills, and beginner-friendly builds.", href: "/classes" }, { number: "4", title: "Maps, Bosses & Loot", description: "Start with the confirmed ruins, treasure, relics, Corroded, Mist Lords, and Returner Woodling loop; exact routes, loot tables, and boss tactics remain 待确认.", href: "/maps-and-loot" }],
  ru: [{ number: "1", title: "Гайд новичка", description: "Изучите управление, цикл extraction, первый комплект и безопасные ранние маршруты.", href: "/beginner-guide" }, { number: "2", title: "Как работает extraction", description: "Разберитесь в одиночных и троечных рейдах, целях карты и Returner Woodling.", href: "/extraction" }, { number: "3", title: "Классы и билды", description: "Сравните шесть классов, стойки оружия, таланты и активные навыки.", href: "/classes" }, { number: "4", title: "Карты, боссы и добыча", description: "Начните с подтверждённого цикла: руины, сокровища, реликвии, Corroded, Mist Lords и Returner Woodling; точные маршруты, таблицы добычи и тактики боссов ожидают подтверждения.", href: "/maps-and-loot" }],
  de: [{ number: "1", title: "Einsteiger-Guide", description: "Lerne Steuerung, Extraction-Loop, erstes Loadout und sichere frühe Routen.", href: "/beginner-guide" }, { number: "2", title: "Extraction verstehen", description: "Verstehe Solo- und Dreierläufe, Kartenziele und Returner Woodlings.", href: "/extraction" }, { number: "3", title: "Klassen und Builds", description: "Vergleiche sechs Klassen, Waffenhaltungen, Talente und aktive Skills.", href: "/classes" }, { number: "4", title: "Karten, Bosse und Beute", description: "Beginne mit dem bestätigten Loop aus Ruinen, Schätzen, Relikten, Corroded, Mist Lords und Returner Woodling; genaue Routen, Loot-Tabellen und Boss-Taktiken sind zu bestätigen.", href: "/maps-and-loot" }],
  "pt-br": [{ number: "1", title: "Guia para iniciantes", description: "Aprenda os controles, o ciclo de extração, o primeiro equipamento e rotas seguras.", href: "/beginner-guide" }, { number: "2", title: "Como funciona a extração", description: "Entenda incursões solo e em trio, objetivos do mapa e Returner Woodlings.", href: "/extraction" }, { number: "3", title: "Classes e builds", description: "Compare as seis classes, posturas de arma, talentos e habilidades ativas.", href: "/classes" }, { number: "4", title: "Mapas, chefes e saque", description: "Comece pelo ciclo confirmado de ruínas, tesouros, relíquias, Corroded, Mist Lords e Returner Woodling; rotas exatas, tabelas de saque e táticas de chefes estão a confirmar.", href: "/maps-and-loot" }],
  zh: [{ number: "1", title: "新手指南", description: "了解操作、撤离循环、第一套装备，以及承担高价值装备风险前的安全路线。", href: "/beginner-guide" }, { number: "2", title: "撤离如何运作", description: "了解单人和三人小队、地图目标、Returner Woodling，以及如何带着战利品离开。", href: "/extraction" }, { number: "3", title: "职业与配装", description: "对比 6 个职业、武器姿态、天赋、主动技能与适合新手的配装。", href: "/classes" }, { number: "4", title: "地图、首领与战利品", description: "先从已确认的遗迹、宝藏、遗物、Corroded、Mist Lords 与 Returner Woodling 循环入手；具体路线、战利品表与首领战术待确认。", href: "/maps-and-loot" }],
};

export const popularPages: Record<Locale, Array<{ tag: string; title: string; description: string; href: string; image: string }>> = {
  en: [{ tag: "Beginner", title: "Beginner Guide", description: "Controls, the extraction loop, first loadout, and safe early routes.", href: "/beginner-guide", image: "/images/mistfall/fight.jpg" }, { tag: "Core Loop", title: "How Extraction Works", description: "Solo and trio runs, map objectives, Returner Woodlings, and leaving with your haul.", href: "/extraction", image: "/images/mistfall/extract.jpg" }, { tag: "Official", title: "Six Playable Classes", description: "Steam and Xbox confirm six classes and two weapon stances; Mobalytics names Blackarrow, Mercenary, Seer, Shadowstrix, Sorcerer, and Withered Knight. Balance values remain 待确认.", href: "/classes", image: "/images/mistfall/heroes.jpg" }, { tag: "Loot", title: "Maps, Bosses & Loot", description: "Official Xbox and Steam descriptions confirm ruins, treasure, Corroded creatures, Mist Lords, rival Gyldhunters, and Returner Woodling extraction. Exact map coverage, loot tables, boss drops, and affix rules remain 待确认.", href: "/maps-and-loot", image: "/images/mistfall/loot.jpg" }],
  ru: [{ tag: "Новичкам", title: "Гайд новичка", description: "Управление, цикл extraction, первый комплект и безопасные маршруты.", href: "/beginner-guide", image: "/images/mistfall/fight.jpg" }, { tag: "Цикл игры", title: "Как работает extraction", description: "Одиночные и троечные рейды, цели карты и Returner Woodling.", href: "/extraction", image: "/images/mistfall/extract.jpg" }, { tag: "Официально", title: "Шесть игровых классов", description: "Steam и Xbox подтверждают шесть классов и две стойки оружия; Mobalytics называет Blackarrow, Mercenary, Seer, Shadowstrix, Sorcerer и Withered Knight. Баланс ожидает подтверждения.", href: "/classes", image: "/images/mistfall/heroes.jpg" }, { tag: "Добыча", title: "Карты, боссы и добыча", description: "Официальные описания Xbox и Steam подтверждают руины, сокровища, Corroded, Mist Lords, соперников-Gyldhunter и эвакуацию через Returner Woodling. Полное покрытие карт, таблицы добычи, дроп боссов и аффиксы ожидают подтверждения.", href: "/maps-and-loot", image: "/images/mistfall/loot.jpg" }],
  de: [{ tag: "Einsteiger", title: "Einsteiger-Guide", description: "Steuerung, Extraction-Loop, erstes Loadout und sichere frühe Routen.", href: "/beginner-guide", image: "/images/mistfall/fight.jpg" }, { tag: "Kern-Loop", title: "Wie Extraction funktioniert", description: "Solo- und Dreierläufe, Kartenziele und Returner Woodling.", href: "/extraction", image: "/images/mistfall/extract.jpg" }, { tag: "Offiziell", title: "Sechs spielbare Klassen", description: "Steam und Xbox bestätigen sechs Klassen und zwei Waffenhaltungen; Mobalytics nennt Blackarrow, Mercenary, Seer, Shadowstrix, Sorcerer und Withered Knight. Balancewerte sind zu bestätigen.", href: "/classes", image: "/images/mistfall/heroes.jpg" }, { tag: "Beute", title: "Karten, Bosse und Beute", description: "Die offiziellen Xbox- und Steam-Beschreibungen bestätigen Ruinen, Schätze, Corroded, Mist Lords, rivalisierende Gyldhunter und die Extraction über Returner Woodling. Genaue Kartenabdeckung, Loot-Tabellen, Boss-Drops und Affix-Regeln sind zu bestätigen.", href: "/maps-and-loot", image: "/images/mistfall/loot.jpg" }],
  "pt-br": [{ tag: "Iniciantes", title: "Guia para iniciantes", description: "Controles, ciclo de extração, primeiro equipamento e rotas seguras.", href: "/beginner-guide", image: "/images/mistfall/fight.jpg" }, { tag: "Ciclo principal", title: "Como funciona a extração", description: "Incursões solo e em trio, objetivos do mapa e Returner Woodling.", href: "/extraction", image: "/images/mistfall/extract.jpg" }, { tag: "Oficial", title: "Seis classes jogáveis", description: "Steam e Xbox confirmam seis classes e duas posturas de arma; a Mobalytics nomeia Blackarrow, Mercenary, Seer, Shadowstrix, Sorcerer e Withered Knight. O balanceamento está a confirmar.", href: "/classes", image: "/images/mistfall/heroes.jpg" }, { tag: "Saque", title: "Mapas, chefes e saque", description: "As descrições oficiais do Xbox e da Steam confirmam ruínas, tesouros, Corroded, Mist Lords, Gyldhunters rivais e a extração pelo Returner Woodling. A cobertura exata dos mapas, tabelas de saque, drops de chefes e regras de afixos está a confirmar.", href: "/maps-and-loot", image: "/images/mistfall/loot.jpg" }],
  zh: [{ tag: "新手", title: "新手指南", description: "操作、撤离循环、第一套装备与安全的前期路线。", href: "/beginner-guide", image: "/images/mistfall/fight.jpg" }, { tag: "核心循环", title: "撤离如何运作", description: "单人和三人小队、地图目标、Returner Woodling，以及带着战利品离开。", href: "/extraction", image: "/images/mistfall/extract.jpg" }, { tag: "官方信息", title: "6 个可玩职业", description: "Steam 与 Xbox 资料确认有 6 个职业和两种武器姿态；Mobalytics 列出 Blackarrow、Mercenary、Seer、Shadowstrix、Sorcerer 与 Withered Knight。具体平衡数值待确认。", href: "/classes", image: "/images/mistfall/heroes.jpg" }, { tag: "战利品", title: "地图、首领与战利品", description: "Xbox 与 Steam 官方描述确认遗迹中的宝藏、Corroded 生物、Mist Lords、遗物、敌对 Gyldhunters，以及通过 Returner Woodling 撤离。具体地图覆盖、战利品表、首领掉落与词缀规则待确认。", href: "/maps-and-loot", image: "/images/mistfall/loot.jpg" }],
};

export const exploreCards: Record<Locale, Array<[string, string, string]>> = {
  en: [["Classes & Builds", "Steam and Xbox confirm six classes and two weapon stances; Mobalytics lists the class names. Exact skill values and balance remain 待确认.", "/classes"], ["Extraction Loop", "Learn the PvPvE loop, solo or trio runs, Returner Woodlings, and extraction risk.", "/extraction"], ["Maps, Bosses & Loot", "Xbox and Steam confirm ruins, treasure, relics, Corroded creatures, Mist Lords, rival Gyldhunters, and Returner Woodling extraction. Exact map coverage, loot priorities, and boss rules remain 待确认.", "/maps-and-loot"], ["Official Updates", "Follow the latest official update and player-count snapshots.", "/updates"], ["Official Community", "Open the official website, Steam community, Discord directory, X, and YouTube.", "/community"], ["Active Codes", "暂无官方可验证兑换码。这个页面只会收录可核验的官方代码。", "/codes"]],
  ru: [["Классы и билды", "Steam и Xbox подтверждают шесть классов и две стойки оружия; Mobalytics перечисляет их названия. Точные навыки и баланс ожидают подтверждения.", "/classes"], ["Цикл extraction", "Изучите PvPvE, одиночные и троечные рейды, Returner Woodling и риск эвакуации.", "/extraction"], ["Карты, боссы и добыча", "Xbox и Steam подтверждают руины, сокровища, реликвии, Corroded, Mist Lords, соперников-Gyldhunter и эвакуацию через Returner Woodling. Точные карты, приоритеты добычи и правила боссов ожидают подтверждения.", "/maps-and-loot"], ["Официальные обновления", "Следите за официальными обновлениями и снимками онлайна.", "/updates"], ["Официальное сообщество", "Сайт, Steam, Discord, X и YouTube по официальным ссылкам.", "/community"], ["Активные коды", "Официально подтверждённых кодов пока нет; здесь будут только проверенные коды.", "/codes"]],
  de: [["Klassen und Builds", "Steam und Xbox bestätigen sechs Klassen und zwei Waffenhaltungen; Mobalytics nennt die Klassennamen. Genaue Skills und Balancewerte sind zu bestätigen.", "/classes"], ["Extraction-Loop", "PvPvE, Solo- und Dreierläufe, Returner Woodling und das Risiko der Extraction.", "/extraction"], ["Karten, Bosse und Beute", "Xbox und Steam bestätigen Ruinen, Schätze, Relikte, Corroded, Mist Lords, rivalisierende Gyldhunter und die Extraction über Returner Woodling. Genaue Karten, Beuteprioritäten und Bossregeln sind zu bestätigen.", "/maps-and-loot"], ["Offizielle Updates", "Verfolge offizielle Updates und Spieler-Snapshots.", "/updates"], ["Offizielle Community", "Website, Steam, Discord, X und YouTube über offizielle Links.", "/community"], ["Aktive Codes", "暂无 offiziell bestätigte Codes; hier erscheinen nur verifizierte Codes.", "/codes"]],
  "pt-br": [["Classes e builds", "Steam e Xbox confirmam seis classes e duas posturas de arma; a Mobalytics lista os nomes. Valores exatos de habilidades e balanceamento estão a confirmar.", "/classes"], ["Ciclo de extração", "PvPvE, incursões solo ou em trio, Returner Woodling e risco da extração.", "/extraction"], ["Mapas, chefes e saque", "Xbox e Steam confirmam ruínas, tesouros, relíquias, Corroded, Mist Lords, Gyldhunters rivais e a extração pelo Returner Woodling. Mapas exatos, prioridades de saque e regras dos chefes estão a confirmar.", "/maps-and-loot"], ["Atualizações oficiais", "Acompanhe atualizações oficiais e snapshots de jogadores.", "/updates"], ["Comunidade oficial", "Site, Steam, Discord, X e YouTube por links oficiais.", "/community"], ["Códigos ativos", "暂无 códigos oficialmente verificáveis; só códigos confirmados serão publicados.", "/codes"]],
  zh: [["职业与配装", "Steam 与 Xbox 资料确认有 6 个职业和两种武器姿态；Mobalytics 列出具体职业名。技能数值与平衡数据待确认。", "/classes"], ["撤离循环", "了解 PvPvE、单人或三人小队、Returner Woodling 与撤离风险。", "/extraction"], ["地图、首领与战利品", "Xbox 与 Steam 官方资料确认遗迹、宝藏、遗物、Corroded 生物、Mist Lords、敌对 Gyldhunters 与通过 Returner Woodling 撤离。具体地图覆盖、战利品优先级与首领规则待确认。", "/maps-and-loot"], ["官方更新", "跟进官方更新与在线人数快照。", "/updates"], ["官方社区", "通过官方链接访问官网、Steam、Discord、X 与 YouTube。", "/community"], ["当前兑换码", "暂无官方可验证兑换码；此页只收录可核验的官方代码。", "/codes"]],
};

export const faqItems: Record<Locale, Array<[string, string]>> = {
  en: [["What is Mistfall Hunter?", "Mistfall Hunter is a dark fantasy third-person PvPvE extraction ARPG. The official research brief describes corrupted monsters, rival Gyldhunters, extraction risk, and the Gyldenmist world."], ["How many playable classes are there?", "Official Steam and Xbox descriptions confirm six distinct classes and two weapon stances per class. The Mobalytics class guide names them Blackarrow, Mercenary, Seer, Shadowstrix, Sorcerer, and Withered Knight; exact skill values and balance rankings are not published in the official descriptions."], ["How large can a squad be?", "The official research brief lists a maximum squad size of 3 players."], ["Which platforms are listed?", "The research brief lists Steam, Xbox Series X|S, and PS5."], ["Are there active codes?", "暂无官方可验证兑换码. This wiki will only publish a code after it can be verified from an official source."], ["When was Mistfall Hunter launched?", "The research snapshot lists Jul 29, 2026 as the launch date and Aug 15, 2026 as the latest official update snapshot."]],
  ru: [["Что такое Mistfall Hunter?", "Mistfall Hunter — мрачная фэнтезийная PvPvE extraction ARPG от третьего лица с искажёнными монстрами, соперниками-Gyldhunter и риском эвакуации."], ["Сколько игровых классов?", "Официальные страницы Steam и Xbox подтверждают шесть классов и по две стойки оружия. Гайд Mobalytics называет Blackarrow, Mercenary, Seer, Shadowstrix, Sorcerer и Withered Knight; точные навыки и баланс ожидают подтверждения."], ["Какой размер отряда?", "В исследовательском брифе указан отряд максимум из 3 игроков."], ["Какие платформы указаны?", "В брифе указаны Steam, Xbox Series X|S и PS5."], ["Есть ли активные коды?", "Официально подтверждённых кодов пока нет. Вики будет публиковать только проверенные коды."], ["Когда вышла игра?", "В исследовательском снимке указаны 29 июля 2026 года как дата запуска и 15 августа 2026 года как дата последнего официального обновления."]],
  de: [["Was ist Mistfall Hunter?", "Mistfall Hunter ist ein düsteres Third-Person-PvPvE-Extraction-ARPG mit verdorbenen Monstern, rivalisierenden Gyldhuntern und Extraction-Risiko."], ["Wie viele spielbare Klassen gibt es?", "Die offiziellen Steam- und Xbox-Beschreibungen bestätigen sechs Klassen und zwei Waffenhaltungen pro Klasse. Der Mobalytics-Guide nennt Blackarrow, Mercenary, Seer, Shadowstrix, Sorcerer und Withered Knight; genaue Skills und Balancewerte sind zu bestätigen."], ["Wie groß kann ein Team sein?", "Der Recherchebrief nennt maximal 3 Spieler pro Team."], ["Welche Plattformen sind gelistet?", "Gelistet sind Steam, Xbox Series X|S und PS5."], ["Gibt es aktive Codes?", "暂无 offiziell bestätigte Codes. Dieses Wiki veröffentlicht nur Codes, die aus einer offiziellen Quelle verifiziert wurden."], ["Wann ist das Spiel erschienen?", "Der Recherche-Snapshot nennt den 29. Juli 2026 als Start und den 15. August 2026 als jüngsten offiziellen Update-Snapshot."]],
  "pt-br": [["O que é Mistfall Hunter?", "Mistfall Hunter é um extraction ARPG PvPvE de fantasia sombria em terceira pessoa, com monstros corrompidos, Gyldhunters rivais e risco de extração."], ["Quantas classes jogáveis existem?", "As descrições oficiais da Steam e do Xbox confirmam seis classes e duas posturas de arma por classe. O guia da Mobalytics nomeia Blackarrow, Mercenary, Seer, Shadowstrix, Sorcerer e Withered Knight; valores exatos de habilidades e balanceamento estão a confirmar."], ["Qual é o tamanho do grupo?", "O material da pesquisa indica um grupo máximo de 3 jogadores."], ["Quais plataformas estão listadas?", "O material lista Steam, Xbox Series X|S e PS5."], ["Existem códigos ativos?", "暂无 códigos oficialmente verificáveis. Esta wiki só publicará códigos confirmados por uma fonte oficial."], ["Quando Mistfall Hunter foi lançado?", "O snapshot da pesquisa indica 29 de julho de 2026 como lançamento e 15 de agosto de 2026 como data do snapshot da atualização oficial mais recente."]],
  zh: [["Mistfall Hunter 是什么？", "Mistfall Hunter 是一款黑暗奇幻第三人称 PvPvE 撤离 ARPG，包含腐化怪物、敌对 Gyldhunter 与撤离风险。"], ["有多少个可玩职业？", "Steam 与 Xbox 官方描述确认有 6 个职业、每个职业两种武器姿态。Mobalytics 职业指南列出 Blackarrow、Mercenary、Seer、Shadowstrix、Sorcerer 与 Withered Knight；具体技能数值与平衡排名在官方描述中没有公布。"], ["小队最多几人？", "调研资料列出最多 3 人小队。"], ["有哪些平台？", "调研资料列出 Steam、Xbox Series X|S 和 PS5。"], ["有当前兑换码吗？", "暂无官方可验证兑换码。本 Wiki 只会发布能从官方来源核验的兑换码。"], ["游戏什么时候上线？", "调研资料列出 2026 年 7 月 29 日上线，2026 年 8 月 15 日为最新官方更新快照日期。"]],
};
...
export const classRecords: Record<Locale, ClassRecord[]> = {
  en: [{ slug: "overview", title: "Six Playable Classes", tag: "Official listing", description: "The official Steam page lists six playable classes. Individual class names and class-by-class values are 待确认.", image: "/images/mistfall/heroes.jpg" }, { slug: "builds", title: "Class Builds", tag: "Cross-checked reports", description: "Mobalytics, KeenGamer, MetaMist, and Destructoid reports cover class routes, skills, talents, and affixes; exact balance values and official import codes remain 待确认.", image: "/images/mistfall/fight.jpg" }],
  ru: [{ slug: "overview", title: "Шесть игровых классов", tag: "Официальный список", description: "Официальная страница Steam указывает шесть классов. Названия и значения каждого класса ожидают подтверждения.", image: "/images/mistfall/heroes.jpg" }, { slug: "builds", title: "Билды классов", tag: "Сверенные отчёты", description: "Материалы Mobalytics, KeenGamer, MetaMist и Destructoid описывают пути, навыки, таланты и аффиксы; точные значения баланса и официальные коды импорта ожидают подтверждения.", image: "/images/mistfall/fight.jpg" }],
  de: [{ slug: "overview", title: "Sechs spielbare Klassen", tag: "Offizielle Angabe", description: "Die offizielle Steam-Seite nennt sechs Klassen. Einzelne Namen und Werte sind zu bestätigen.", image: "/images/mistfall/heroes.jpg" }, { slug: "builds", title: "Klassen-Builds", tag: "Quellenabgleich", description: "Berichte von Mobalytics, KeenGamer, MetaMist und Destructoid decken Wege, Skills, Talente und Affixe ab; genaue Balancewerte und offizielle Importcodes sind zu bestätigen.", image: "/images/mistfall/fight.jpg" }],
  "pt-br": [{ slug: "overview", title: "Seis classes jogáveis", tag: "Listagem oficial", description: "A página oficial da Steam lista seis classes. Os nomes e valores individuais estão a confirmar.", image: "/images/mistfall/heroes.jpg" }, { slug: "builds", title: "Builds de classes", tag: "Relatos cruzados", description: "Relatos da Mobalytics, KeenGamer, MetaMist e Destructoid cobrem caminhos, habilidades, talentos e afixos; valores exatos de balanceamento e códigos oficiais de importação estão a confirmar.", image: "/images/mistfall/fight.jpg" }],
  zh: [{ slug: "overview", title: "6 个可玩职业", tag: "官方列出", description: "官方 Steam 页面列出 6 个可玩职业。具体职业名称与逐职业数值待确认。", image: "/images/mistfall/heroes.jpg" }, { slug: "builds", title: "职业配装", tag: "交叉核验参考", description: "已交叉核验 Mobalytics、KeenGamer、MetaMist 与 Destructoid 的职业路线、技能、天赋和词缀资料；精确平衡数值与官方导入码仍待确认。", image: "/images/mistfall/fight.jpg" }],
};

...
export const exploreCards: Record<Locale, Array<[string, string, string]>> = {
  ...
  ru: [["Классы и билды", "Steam и Xbox подтверждают шесть классов и две стойки оружия; Mobalytics перечисляет их названия. Точные навыки и баланс ожидают подтверждения.", "/classes"], ["Цикл extraction", "Изучите PvPvE, одиночные и троечные рейды, Returner Woodling и риск эвакуации.", "/extraction"], ["Карты, боссы и добыча", "Gyldenmist, Mist Lords, реликвии и детали, требующие проверки.", "/maps-and-loot"], ["Официальные обновления", "Следите за официальными обновлениями и снимками онлайна.", "/updates"], ["Официальное сообщество", "Сайт, Steam, Discord, X и YouTube по официальным ссылкам.", "/community"], ["Активные коды", "Официально подтверждённых кодов пока нет; здесь будут только проверенные коды.", "/codes"]],
  de: [["Klassen und Builds", "Steam und Xbox bestätigen sechs Klassen und zwei Waffenhaltungen; Mobalytics nennt die Klassennamen. Genaue Skills und Balancewerte sind zu bestätigen.", "/classes"], ["Extraction-Loop", "PvPvE, Solo- und Dreierläufe, Returner Woodling und das Risiko der Extraction.", "/extraction"], ["Karten, Bosse und Beute", "Gyldenmist, Mist Lords, Relikte und noch zu prüfende Details.", "/maps-and-loot"], ["Offizielle Updates", "Verfolge offizielle Updates und Spieler-Snapshots.", "/updates"], ["Offizielle Community", "Website, Steam, Discord, X und YouTube über offizielle Links.", "/community"], ["Aktive Codes", "暂无 offiziell bestätigte Codes; hier erscheinen nur verifizierte Codes.", "/codes"]],

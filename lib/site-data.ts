...
export const classRecords: Record<Locale, ClassRecord[]> = {
  en: [{ slug: "overview", title: "Six Playable Classes", tag: "Official listing", description: "The official Steam page lists six playable classes. The class names are covered in the source-labeled class material.", image: "/images/mistfall/heroes.jpg" }, { slug: "builds", title: "Class Builds", tag: "Cross-checked reports", description: "Mobalytics, KeenGamer, MetaMist, and Destructoid reports cover class routes, skills, talents, and affixes; this page keeps shared directions separate from numeric tables and import strings.", image: "/images/mistfall/fight.jpg" }],
  ru: [{ slug: "overview", title: "Шесть игровых классов", tag: "Официальный список", description: "Официальная страница Steam указывает шесть классов. Названия приведены в материалах классов с указанными источниками.", image: "/images/mistfall/heroes.jpg" }, { slug: "builds", title: "Билды классов", tag: "Сверенные отчёты", description: "Материалы Mobalytics, KeenGamer, MetaMist и Destructoid описывают пути, навыки, таланты и аффиксы; страница отделяет общие направления от числовых таблиц и строк импорта.", image: "/images/mistfall/fight.jpg" }],
  de: [{ slug: "overview", title: "Sechs spielbare Klassen", tag: "Offizielle Angabe", description: "Die offizielle Steam-Seite nennt sechs Klassen. Die Namen stehen im quellenmarkierten Klassenmaterial.", image: "/images/mistfall/heroes.jpg" }, { slug: "builds", title: "Klassen-Builds", tag: "Quellenabgleich", description: "Berichte von Mobalytics, KeenGamer, MetaMist und Destructoid decken Wege, Skills, Talente und Affixe ab; die Seite trennt gemeinsame Richtungen von Zahlentabellen und Importstrings.", image: "/images/mistfall/fight.jpg" }],
  "pt-br": [{ slug: "overview", title: "Seis classes jogáveis", tag: "Listagem oficial", description: "A página oficial da Steam lista seis classes. Os nomes aparecem no material de classes com fontes indicadas.", image: "/images/mistfall/heroes.jpg" }, { slug: "builds", title: "Builds de classes", tag: "Relatos cruzados", description: "Relatos da Mobalytics, KeenGamer, MetaMist e Destructoid cobrem caminhos, habilidades, talentos e afixos; a página separa direções compartilhadas de tabelas numéricas e strings de importação.", image: "/images/mistfall/fight.jpg" }],
  zh: [{ slug: "overview", title: "6 个可玩职业", tag: "官方列出", description: "官方 Steam 页面列出 6 个可玩职业，职业名称收录在标注来源的职业资料中。", image: "/images/mistfall/heroes.jpg" }, { slug: "builds", title: "职业配装", tag: "交叉核验参考", description: "已交叉核验 Mobalytics、KeenGamer、MetaMist 与 Destructoid 的职业路线、技能、天赋和词缀资料；本页将共识方向与数值表、导入字符串分开处理。", image: "/images/mistfall/fight.jpg" }],
};

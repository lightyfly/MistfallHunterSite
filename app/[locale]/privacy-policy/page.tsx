...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) { const { locale } = await params; if (!dynamicLocales.includes(locale as Locale)) notFound(); return <LegalPage locale={locale as Locale} kind="privacy" />; }
